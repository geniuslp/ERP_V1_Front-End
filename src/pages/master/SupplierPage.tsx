...
const SupplierPage: React.FC = () => {
  ...
  const handleBulkSubmit = async () => {
    ...
    if (nonEmptyRows.some((r) => !r.supplier_name.trim())) {
      message.error('กรุณากรอกชื่อร้านค้า / บริษัท (จำเป็น) ให้ครบทุกแถว')
      return
    }
  ...
  const panelUploadColumns = [
    ...
    { title: 'ชื่อร้านค้า / บริษัท', dataIndex: 'supplier_name', width: 160 },
  ...
  const createdSupplierColumns = [
    { title: 'ชื่อร้านค้า / บริษัท', dataIndex: 'supplier_name', key: 'supplier_name' },
    {
  ...
  const supplierForm = (
    <Form form={form} layout="vertical" style={{ marginTop: 8 }}>
      <Form.Item name="supplier_name" label="ชื่อร้านค้า / บริษัท" rules={[{ required: true, message: 'กรุณากรอกชื่อร้านค้า / บริษัท' }]}>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: 1100 }}>
              <thead>
                <tr style={{ background: '#2563a8', position: 'sticky', top: 0 }}>
                  {[
                    '#', 'ชื่อร้านค้า / บริษัท', 'เลขประจำตัวผู้เสียภาษี', 'ที่อยู่', 'ผู้ติดต่อ',
  ...
  const bulkColumns = [
    {
      title: <span>ชื่อร้านค้า / บริษัท <span style={{ color: '#dc2626' }}>*</span></span>,
      key: 'supplier_name',
      width: 200,
    ...
    <div>
      ...
      <Card
        ...
        extra={
          <Space>
            <Input
              placeholder="ค้นหาชื่อร้านค้า / บริษัท"
              allowClear
        ...
        {bulkResult ? (
          ...
          <div>
            <div style={{ marginBottom: 12, fontSize: 13, color: '#6b7280' }}>
              กรอกข้อมูลผู้ขายหลายรายการพร้อมกัน — ต้องระบุ "ชื่อร้านค้า / บริษัท" เท่านั้น ฟิลด์อื่นเว้นว่างได้ (รหัสผู้ขายจะถูกสร้างโดยระบบอัตโนมัติ)
            </div>
            <Table
              rowKey="key"
              size="small"
